...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "dec99f0d-b59b-4448-82a7-08dfa0988eb7",
  ...
  "public": {},
  "FEISHU_APP_ID": "cli_a8819a6b8238901c",
  "FEISHU_APP_SECRET": "XLGZJBFL2eBbMb4kbisDZe68JHRJW3B4",
  "FEISHU_BASE_ID": "PkSmbBO7laUzTUscxPqcqAI9nGb",
  "FEISHU_TABLE_ID": "tblBlqz8tTD74yGh",
  "icon": {
...
const _bUUqGS = defineCachedEventHandler(async (event) => {
...
const _YSs4xU = lazyEventHandler(() => {
...
const _lazy_oPtLSW = () => import('../routes/api/bookmarks/recommended.mjs');
const _lazy_Z0_N_p = () => import('../routes/api/bookmarks/search.mjs');
const _lazy_IWw7Q3 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/bookmarks/recommended', handler: _lazy_oPtLSW, lazy: true, middleware: false, method: undefined },
  { route: '/api/bookmarks/search', handler: _lazy_Z0_N_p, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_IWw7Q3, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _bUUqGS, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _YSs4xU, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_IWw7Q3, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, klona as A, parseQuery as B, withTrailingSlash as C, withoutTrailingSlash as D, getQuery as a, buildAssetsURL as b, createError$1 as c, defineEventHandler as d, useRuntimeConfig as e, getResponseStatusText as f, getRouteRulesForPath as g, getResponseStatus as h, defineRenderHandler as i, joinHeaders as j, getRouteRules as k, createHooks as l, getContext as m, normalizeCookieHeader as n, createRouter$1 as o, publicAssetsURL as p, defu as q, hasProtocol as r, joinURL as s, toRouteMatcher as t, useNitroApp as u, sanitizeStatusCode as v, withQuery as w, isScriptProtocol as x, executeAsync as y, defuFn as z };
