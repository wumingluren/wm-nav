...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"一个简单高效的無名导航"}],"link":[],"style":[],"script":[],"noscript":[],"title":"無名导航"};
